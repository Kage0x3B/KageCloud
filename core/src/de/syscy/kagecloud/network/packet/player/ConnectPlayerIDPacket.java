...
@NoArgsConstructor
public class ConnectPlayerIDPacket extends IDPacket {
	private @Getter String playerId;
	private @Getter String serverName;
	private @Getter boolean exactServer;

	public ConnectPlayerIDPacket(CloudPlayer player, CloudServer server) {
		this(player.getId().toString(), server.getName(), true);
	}

	public ConnectPlayerIDPacket(String playerId, String serverName) {
	 ...
	 */
	public ConnectPlayerIDPacket(String playerId, String serverName, boolean exactServer) {
